...
export const EXAMENS_PRENATAUX: ExamenPrenatal[] = [
  ...
  },
  {
    id: 'echo_t1',
    type: 'echographie',
    nom: 'Echographie du 1er trimestre',
    saPrevue: 12,
    saMin: 11,
    saMax: 14,
    obligatoire: true,
    description: 'Datation, clarte nucale, depistage T21',
  },
  {
    id: 'depistage_t21',
    type: 'prise_sang',
    nom: 'Depistage T21 (marqueurs seriques)',
    saPrevue: 12,
    saMin: 11,
    saMax: 14,
    obligatoire: false,
    description: 'Dosage des marqueurs seriques pour le depistage de la trisomie 21',
  },
  {
    id: 'bilan_t1',
    type: 'prise_sang',
    nom: 'Bilan sanguin du 1er trimestre',
    saPrevue: 10,
    saMin: 1,
    saMax: 14,
    obligatoire: true,
    description: 'Groupe sanguin, RAI, serologies (toxo, rubeo, syphilis, VIH, HBV)',
  },
  {
    id: 'glycemie_jeun',
    type: 'prise_sang',
    ...
    saMax: 14,
    obligatoire: true,
    description: 'Depistage du diabete pre-gestationnel',
  },
  {
    id: 'echo_t2',
    type: 'echographie',
    nom: 'Echographie morphologique T2',
    saPrevue: 22,
    saMin: 20,
    saMax: 24,
    obligatoire: true,
    description: 'Etude morphologique complete du foetus',
  },
  {
    id: 'rai_mensuel',
    type: 'prise_sang',
    nom: 'RAI mensuel (si Rh-)',
    saPrevue: 28,
    saMin: 24,
    saMax: 34,
    obligatoire: false,
    description: 'Pour les femmes de rhesus negatif',
  },
  {
    id: 'hgpo',
    type: 'prise_sang',
    ...
    saMax: 28,
    obligatoire: false,
    description: 'Depistage du diabete gestationnel si facteurs de risque',
  },
  {
    id: 'injection_rhophylac',
    type: 'injection',
    nom: 'Injection Rhophylac (si Rh-)',
    saPrevue: 28,
    saMin: 28,
    saMax: 30,
    obligatoire: false,
    description: 'Prophylaxie anti-D pour les femmes de rhesus negatif',
  },
  {
    id: 'echo_t3',
    type: 'echographie',
    nom: 'Echographie du 3eme trimestre',
    saPrevue: 32,
    saMin: 30,
    saMax: 34,
    obligatoire: true,
    description: 'Croissance foetale, liquide amniotique, position du placenta',
  },
  {
    id: 'prelev_vaginal',
    type: 'prelevement',
    nom: 'Prelevement vaginal (strepto B)',
    saPrevue: 35,
    saMin: 34,
    saMax: 38,
    obligatoire: true,
    description: 'Depistage du streptocoque B',
  },
  {
    ...
    saMax: 38,
    obligatoire: true,
    description: 'Consultation obligatoire avec un anesthesiste',
  },
]
